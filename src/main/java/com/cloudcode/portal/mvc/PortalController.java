package com.cloudcode.portal.mvc;
...
public class PortalController extends CrudController<Staff> {
	@Autowired
	...
	public ModelAndView index() {
		...
		modelAndView.setViewName("classpath:com/cloudcode/portal/ftl/index.ftl");
		return modelAndView;
	}
